...
OUTDIR=output_linux-spring.gnu
...
archive: ../lib/libsmm_dnn_linux-spring.gnu.a 

../lib/libsmm_dnn_linux-spring.gnu.a: $(OBJFILES) $(OUTDIR)/$(DRIVER) 
	 ar -r $@ $^ 
	 @echo 'Library produced at /home/tong/src/cp2k/cp2k/tools/build_libsmm/lib/libsmm_dnn_linux-spring.gnu.a'
